 ...
 * @author mahmo
 */
public class RestaurantAdminLogin extends javax.swing.JFrame {
     static Restaurant_Admin tempRestAdmin = new Restaurant_Admin();
    /**
     * Creates new form AdminLogin
     */
    public RestaurantAdminLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome To Restaurant Admin Login Page");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RestaurantAdminLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RestaurantAdminLogin().setVisible(true);
            }
        });
    }
